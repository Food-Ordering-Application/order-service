...
export { IRestaurantVoidOrderResponse } from './restaurant-void-order-response.interface';
...
export { IRestaurantFinishOrderResponse } from './restaurant-finish-order-response.interface';
